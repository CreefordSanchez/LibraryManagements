	...
	public class LibraryManagementContext : IdentityDbContext<IdentityUser> {
		...
		protected override void OnModelCreating(ModelBuilder builder) {
			...
			builder.Entity<BookReview>().HasData(
				new BookReview {
					BookReviewId = 1,
					UserId = "b6463de8-1ab0-4c7e-9684-8821b35f8f6b",
					Rating = 5,
				...
				new BookReview {
					BookReviewId = 2,
					UserId = "f9f6317b-357b-4863-8d90-160e763588cb",
					Rating = 4,
			...
			builder.Entity<CheckOut>().HasData(
				...
				new CheckOut {
					CheckOutId = 1,
					BookId = 1,
					UserId = "cec98e7e-f61e-49a2-b205-a28d9ba6b241",
					IsReturned = false,
					IsOverdue = true,
				...
				new CheckOut {
					CheckOutId = 2,
					BookId = 2,
					UserId = "51c6054b-4193-4e8f-9311-a558823d11b5",
					IsReturned = false,
					IsOverdue = false,
			...
			builder.Entity<Event>().HasData(
				new Event {
					...
					OrganiserId = "9eafc88b-37a6-455c-adc8-420441e1860f"
				},
				new Event {
					EventId = 2,
			...
			builder.Entity<EventReview>().HasData(
				...
				new EventReview {
					EventReviewId = 2,
					UserId = "e340b85c-18e4-4b02-a1d5-d668fee4d956",
					Rating = 4,
